...
**`header_meta`.** A deterministic serialization hash of the public KEM header: share index $i$, $\{D_{1,j}\}$, $\{D_{2,k}\}$, $T_i$, $h_i$, and `GS_instance_digest`. Use strict encodings and reject duplicates.
